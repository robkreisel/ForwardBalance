...
namespace ForwardBalance.API.Migrations
{
    ...
    [Migration("20200419013711_UpdateDescriptionOfSystemAccount")]
    partial class UpdateDescriptionOfSystemAccount
    {
            ...
            modelBuilder.Entity("ForwardBalance.API.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AccountNumber = 0, BankId = 1, Description = "System account for transfers in and out of listed accounts", Name = "Cash Account" }
                    );
                });
